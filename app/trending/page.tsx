...
export default async function TrendingPage() {
  ...
  const trendingTools = tools.sort((a, b) => b.id.length - a.id.length).slice(0, 12)

  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      <Navbar activeItem="trending" />
      ...
      <div className="container mx-auto px-4 py-12 pt-32">
        ...
        <div className="mb-8">
          <h1 className="text-3xl md:text-4xl font-bold text-white mb-2">Trending AI Tools</h1>
